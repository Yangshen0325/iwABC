...
#SBATCH --output=logsMaster/sbatch_master_submit-%j.log
...
CHUNK_SIZE=${CHUNK_SIZE:-20}           # submit this many jobs per batch
SLEEP_BETWEEN=${SLEEP_BETWEEN:-15m}      # sleep time between batches (e.g., "1h" or "3600")
